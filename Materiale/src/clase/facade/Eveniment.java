...
public class Eveniment {
	...
	public String getStareSala() {
		
		String stareString = "";
		
		if(dimensiuneLocatie >= 3500f) {
			stareString = "Sala mare";
		} else if (dimensiuneLocatie >= 2500f && dimensiuneLocatie >= 1000f) {
			stareString = "Sala medie";
		}else if (dimensiuneLocatie <= 1000f) {
			stareString = "Sala mica";
		}
