...
public class Eveniment implements EvenimentAbstract {
	private String nume;
	...
	public void participanti(TipEveniment tipEveniment, int nrParticipanti) {
		System.out.println("S-a organizat un eveniment de tip " + tipEveniment + " cu " + nrParticipanti + " de participanti");		
	}
